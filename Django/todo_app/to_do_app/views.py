...
def index(request):
    if request.method == "POST":
        ...
        if form.is_valid:
            ...
            return render(request,"to_do_app/index.html",{"todo_list":todo_list})
    else:
        todo_list=Todos.objects.all()
        return render(request,"to_do_app/index.html",{"todo_list":todo_list})

def about(request):
    return render(request,"to_do_app/about.html")
...
def create(request):
    if request.method == "POST":
        ...
        if form.is_valid:
            form.save()
            todo_list=Todos.objects.all()
            return render(request,"to_do_app/create.html",{"todo_list":todo_list})
    else:
        todo_list=Todos.objects.all()
        return render(request,"to_do_app/create.html",{"todo_list":todo_list})
...
def update(request,Todos_id):
    if request.method == "POST":
        ...
        todo_list=Todos.objects.all()
        return render(request,"to_do_app/update.html",{"todo_list":todo_list})